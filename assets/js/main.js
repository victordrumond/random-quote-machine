...
let colorBank = [
    "EE766D", "3A3335", "F093B2", "F8CD77", "86ACA1", "018FB7", "3C6E71", "707070", "0D5946",
    "1D4A5D", "6AA08C", "324376", "582E60", "F0A741", "8A050C", "586BA4", "732C2C", "011627"
];
...
const generateQuote = () => {
    ...
    // Randomly select a quote and its author from the bank of quotes
    ...
    // Store all the information as the current values 
    currentQuote = {
        text: $("#text").html(),
        author: $("#author").html()
    };
    ...
    // Push the current information to the storage arrays
